...
# See docs/design/art/VISUAL_QA.md — catches BoxMesh placeholders before they spread.
set -euo pipefail
...
echo "==> Scene visual lint (docs/design/art/VISUAL_QA.md)"
...
if [[ "$FAIL" -gt 0 ]]; then
  ...
  echo "Fix: replace primitives with NPR meshes per docs/design/art/ART_AUTOMATION_PIPELINE.md"
  exit 1
fi
