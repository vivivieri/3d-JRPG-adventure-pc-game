...
| `docs/technical/GDSCRIPT_REGENERATION.md` | Step-by-step port workflow for deleted `game/scripts/core/*.gd` |
...
**Reference libs are not ship code.** They express behavior for later GDScript ports (`docs/technical/GDSCRIPT_REGENERATION.md`).
