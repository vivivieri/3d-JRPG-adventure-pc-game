...
# --- Directory layout (docs/design/world/ENVIRONMENT_KITS.md, docs/design/art/ART_DIRECTION.md) ---
DIRS=(
  game/assets/fonts
...
if [[ ! -d game/addons/gdai-mcp-plugin-godot ]]; then
  ...
  echo "   See: game/addons/README.md + docs/ops/agents/GDAI_CLOUD_SETUP.md"
fi
...
echo
echo "==> Setup complete."
echo "    1. Install Godot 4.7 and open game/project.godot (see docs/engineering/technical/TECH_STACK.md)"
