...
**Cross-refs:** `docs/design/art/ART_AUTOMATION_PIPELINE.md` §5, `docs/design/art/MODEL_QA.md` (asset QA before in-scene), `docs/ops/qa/QA_REMEDIATION_LOOP.md` (FAIL → fix loop), `docs/ops/qa/ACCEPTANCE_CRITERIA.md` (gate `L2_visual_*`)
