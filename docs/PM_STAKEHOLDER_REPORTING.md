...
**Cross-refs:** `docs/PM_AGENT_RUNBOOK.md`, `game/data/qa/stakeholder_report_config.json`
...
- `docs/CLOUD_AGENT_SETUP_RUNBOOK.md` — Automation secrets
- `docs/FACTORY_WATCHDOG.md` — factory health section in report
