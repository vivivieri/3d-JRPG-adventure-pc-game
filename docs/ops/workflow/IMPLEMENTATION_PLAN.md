...
| 8.6 | Playtest script (`docs/ops/qa/PLAYTEST_SCRIPT.md`) |
...
- `docs/archive/deprecated/GDAI_REGEN_PLAN.md` — superseded by this plan (old `gdai-regen-dc91` branch deleted)
