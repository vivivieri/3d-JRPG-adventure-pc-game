...
| `L1_*` style gates | Python/shell/JSON/markdown/shader/error-handling lint |
| `M5_asset_compliance` | License manifest |

**Not in merge CI (by design):** visual/model/audio jury, L5 E2E, L6 human — see `docs/ci-cd/CI.md` §3.
