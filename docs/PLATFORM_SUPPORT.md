...
**Cross-refs:** `docs/PERFORMANCE_BASELINE.md`, `docs/CLOUD_SNAPSHOT_LAUNCH.md`, `AGENTS.md`, `docs/IMPLEMENTATION_PLAN.md` Phase 8
...
See `docs/CLOUD_SNAPSHOT_LAUNCH.md`.
...
Same FPS targets (60 @ 1080p Medium) on both — see `docs/PERFORMANCE_BASELINE.md`.
