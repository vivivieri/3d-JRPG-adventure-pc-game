...
echo "    Policy: docs/ops/ci-cd/CI.md, .cursorrules §0, docs/ops/workflow/AI_DEV_WORKFLOW.md §2"
...
run_tri_gate "L0_narrative_density" "Narrative pattern density budgets" \
...
echo ""
echo "Docs: docs/ops/ci-cd/CI.md"
