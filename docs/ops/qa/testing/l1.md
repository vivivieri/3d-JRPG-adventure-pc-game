...
authority: qa
tokens_est: 570
summary: "L1 — Unit tests — covers 3. L1 — Unit tests; Current tests (Phase 0); Tests to add by phase; Agent report line"
---
# L1 — Unit tests
...
Use **L1 — Unit tests** (roles: qa, flow) when you need this reference during the current task Jump to a section below instead of reading end-to-end (5 sections).

## Jump to

- [3. L1 — Unit tests](#3-l1-unit-tests)
- [Current tests (Phase 0)](#current-tests-phase-0)
- [Tests to add by phase](#tests-to-add-by-phase)
- [Agent report line](#agent-report-line)
- [L1b — GDScript lint (changed files)](#l1b-gdscript-lint-changed-files)
