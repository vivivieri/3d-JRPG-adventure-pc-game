...
Per `docs/gameplay/GAME_FEEL.md`. Record per tester; average ≥3.5 required for ship.
...
Per `docs/art/MODEL_QA.md` §9 — F6–F8 are the human arbiter for model polish direction when automated M1–M6 and visual jury pass but motion still feels wrong.
...
Use the full template and severity definitions in **`docs/qa/QA_AND_BUG_PROCESS.md`** §2–§3.
