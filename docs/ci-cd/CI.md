...
| Style / lint | `L1_python_lint`, `L1_shellcheck`, `L1_json_style`, `L1_typescript_lint`, `L1_markdown_style`, `L1_gdshader_style`, `L1_error_handling` |
...
**CD (`cd-artifact.yml`):** exports **Linux + Windows**, packages both Steam depot zips — required for v1 (`docs/qa/PLATFORM_SUPPORT.md`).
