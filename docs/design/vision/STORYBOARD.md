...
**Related docs:** `docs/design/ui/CINEMATICS.md`, `docs/design/art/CHARACTER_BIBLE.md`, `docs/design/world/ENVIRONMENT_KITS.md`, `docs/design/gameplay/TUTORIAL_DESIGN.md`, `docs/design/vision/ENDING_DESIGN.md`, `docs/design/vision/PACING_CHART.md`, `docs/design/vision/NARRATIVE_WRITING_GUIDE.md`, `docs/design/vision/STORYBOARD_ILLUSTRATIONS.md`, `docs/archive/pitch/illustrations/`
