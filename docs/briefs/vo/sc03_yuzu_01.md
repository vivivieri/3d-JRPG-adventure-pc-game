...
**Authority:** `game/data/audio/vo_prompts.json`, `docs/design/vision/VO_HIT_LIST.md`
**Cross-refs:** `docs/design/vision/NARRATIVE_WRITING_GUIDE.md`, `docs/design/audio/AUDIO_PRODUCTION_GUIDE.md` §8
