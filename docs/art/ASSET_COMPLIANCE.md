...
That means you must have a **documented permissive license** or **documented AI service ToS** that allows commercial use and redistribution. Production is **fully automated** — no human artist commission path (`docs/art/ART_AUTOMATION_PIPELINE.md`).
...
4. Add a row to docs/art/LICENSES.md (human-readable log)
...
- Human log: `docs/art/LICENSES.md`
- Machine manifest: `docs/asset_manifest.license.json`
- Art sourcing: `docs/art/ART_DIRECTION.md` §6
- Character imports: `docs/art/CHARACTER_BIBLE.md` §10
- Environment imports: `docs/world/ENVIRONMENT_KITS.md` §11
- Audio imports: `docs/audio/AUDIO_DIRECTION.md` §6
- Risk register: `docs/vision/GDD.md` §16
