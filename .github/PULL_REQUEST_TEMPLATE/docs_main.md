...
- [ ] **Spec refinement mode** — no `.gd`, `.tscn`, `project.godot`, `game/shaders/`, or `game/assets/` on `main` (`docs/engineering/technical/SPEC_FIRST_DEVELOPMENT.md` §10)
...
- [ ] Cross-cutting factory feature registered in `workflow_integration_registry.json` (`docs/ops/qa/WORKFLOW_INTEGRATION.md`)
