...
authority: qa
tokens_est: 785
summary: "L0 — Data validation — covers 2. L0 — Data validation; Checks (automated); Agent report line; L0b — Base class registry"
---
# L0 — Data validation
...
Use **L0 — Data validation** (roles: qa, flow) when you need this reference during the current task Jump to a section below instead of reading end-to-end (8 sections).

## Jump to

- [2. L0 — Data validation](#2-l0-data-validation)
- [Checks (automated)](#checks-automated)
- [Agent report line](#agent-report-line)
- [L0b — Base class registry](#l0b-base-class-registry)
- [Checks (automated)](#checks-automated-1)
- [L0c — Base class compliance (game branch)](#l0c-base-class-compliance-game-branch)
- [L0d — Audio QA catalog (`main` docs CI)](#l0d-audio-qa-catalog-main-docs-ci)
- [Checks (automated)](#checks-automated-2)
