...
**Platform policy:** `docs/ops/qa/PLATFORM_SUPPORT.md` — **Linux ship required** (cloud dev OS)
**Thresholds:** `game/data/qa/perf_thresholds.json`
**Cross-refs:** `docs/design/art/RENDERING_GUIDE.md`, `docs/design/world/ENVIRONMENT_KITS.md` §9, `docs/ops/cheat-sheets/RR_CHEATSHEET.md` §Performance review, `docs/ops/qa/ACCEPTANCE_CRITERIA.md`, `steam/STORE_PAGE.md`
