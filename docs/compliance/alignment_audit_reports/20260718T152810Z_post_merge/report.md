...
**Alignment audit — ALIGNED (cursor/audit-full-alignment-68f4 @ 482ea65) · Spec 9.65/10 · Build N/A/10**
Generated: 2026-07-18T15:28:10Z · Audit ID: `20260718T152810Z_post_merge`
Branch: `cursor/audit-full-alignment-68f4` · Commit: `482ea65`
...
## Legacy visuals (archive — not for management status)
...
*9-domain production radar (legacy) (legacy — not for management)*
![Mega dashboard (legacy — do not use for status)](../../alignment_audit_visuals/tides_mega_dashboard_all_radars.png)
*Mega dashboard (legacy — do not use for status) (legacy — not for management)*
