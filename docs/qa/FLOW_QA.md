...
**Cross-refs:** `docs/qa/AI_TESTING_SPEC.md`, `docs/technical/TECHNICAL_DESIGN.md`, `docs/world/QUEST_AND_FLAGS.md`, `docs/qa/QA_REMEDIATION_LOOP.md`, `docs/qa/ACCEPTANCE_CRITERIA.md`, `game/data/qa/remediation_playbook.json` §`flow` / §`data`
...
Master policy: `docs/qa/QA_REMEDIATION_LOOP.md` §10.
