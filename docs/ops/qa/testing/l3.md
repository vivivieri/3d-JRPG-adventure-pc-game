...
authority: qa
tokens_est: 863
summary: "Runner: GDAI MCP (no shell script — procedural)"
---
...
Use **L3 — GDAI editor verify** (roles: qa, flow) when you need this reference during the current task Jump to a section below instead of reading end-to-end (6 sections).

## Jump to

- [5. L3 — GDAI editor verify](#5-l3-gdai-editor-verify)
- [5.1 Prerequisites](#51-prerequisites)
- [5.2 Standard procedure (every scene task)](#52-standard-procedure-every-scene-task)
- [5.3 Checklists by task type](#53-checklists-by-task-type)
- [5.4 Failure handling](#54-failure-handling)
