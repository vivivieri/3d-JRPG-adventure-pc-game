...
**Alignment audit — ALIGNED (cursor/build-subdomain-radars-68f4 @ fb65c70) · Spec 9.65/10 · Build N/A/10**
Generated: 2026-07-19T06:10:21Z · Audit ID: `20260719T061021Z_post_merge`
Branch: `cursor/build-subdomain-radars-68f4` · Commit: `fb65c70`
...
| Signal | Score |
|--------|-------|
| `L0_ship_build_security` | 10.0 |
| `L0_player_build_protection` | 10.0 |
| `M5_asset_compliance` | 10.0 |
| `runtime_proof` | 3.5 |
...
- [ ] **P2** Refresh stakeholder visual pack — Copy PNGs to docs/archive/compliance/alignment_audit_visuals/ then: bash tools/run_alignment_audit.sh --visuals-from docs/archive/compliance/alignment_audit_visuals
