...
**Authority:** `docs/technical/CODE_BASE_CLASS_RULES.md` · `game/data/code/base_classes.json` · component scenes in `docs/world/LEVEL_DESIGN.md` §1b.
...
| 8.6 | **Human QA** `docs/qa/PLAYTEST_SCRIPT.md` ≥80% complete without guide | Human sign-off **after 8.5** |
...
# Human QA only after L0–L5 pass: docs/qa/PLAYTEST_SCRIPT.md
```
...
| Doc | Focus |
|-----|-------|
| `docs/qa/AI_TESTING_SPEC.md` | **Detailed L0–L6 spec**, L3 procedures, E2E matrix, human QA gate |
| `docs/agents/GDAI_CLOUD_SETUP.md` | MCP install, cloud snapshot, editor bridge |
| `docs/workflow/IMPLEMENTATION_PLAN.md` | What to build each phase |
| `docs/qa/QA_AND_BUG_PROCESS.md` | Bug severity, triage, human QA process |
| `docs/qa/PLAYTEST_SCRIPT.md` | Manual 2–3 h playthrough (**after L5**) |
