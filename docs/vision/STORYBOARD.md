...
**Related docs:** `docs/ui/CINEMATICS.md`, `docs/art/CHARACTER_BIBLE.md`, `docs/world/ENVIRONMENT_KITS.md`, `docs/gameplay/TUTORIAL_DESIGN.md`, `docs/vision/ENDING_DESIGN.md`, `docs/vision/PACING_CHART.md`, `docs/vision/NARRATIVE_WRITING_GUIDE.md`, `docs/vision/STORYBOARD_ILLUSTRATIONS.md`, `docs/pitch/illustrations/`
...
| **Summary** | Urashima washes ashore, clutching the lacquer box. Narrator line: "I thought it was only three days." **Default: text only.** Optional selective VO: `sc01_urashima_01` (P1 — `docs/vision/VO_HIT_LIST.md`) |
