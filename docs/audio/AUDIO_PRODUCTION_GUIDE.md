...
| `Voice` | **Selective VO** — 12 `voice_id` clips only (`docs/vision/VO_HIT_LIST.md`) | `voice_volume` (Phase 2+) |
...
game/assets/audio/
  ...
  sfx/
    ...
    combat/
    story/
docs/audio/audio_sheets/          # Design-time loop sheets (not shipped)
  <track_id>.md
```
...
| **Loop point** | Bar 17 (sample-accurate; document in `docs/audio/audio_sheets/bgm_menu.md`) |
...
Full skill → SFX map: `docs/gameplay/SKILLS_BIBLE.md` + §6 below.
...
Store per-track loop documentation in `docs/audio/audio_sheets/<track_id>.md`:
...
See `docs/ui/SETTINGS_ACCESSIBILITY.md` §1.
...
Automated gates: `docs/audio/AUDIO_QA.md`
...
- [ ] Every external asset in `docs/art/LICENSES.md` + manifest
