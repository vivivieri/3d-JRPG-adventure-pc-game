...
**Cross-refs:** `docs/ops/workflow/AI_DEV_WORKFLOW.md` §4, `docs/engineering/technical/CODE_BASE_CLASS_RULES.md`, `docs/ops/qa/QA_REMEDIATION_LOOP.md`, `docs/ops/qa/FLOW_QA.md`, `docs/design/art/MODEL_QA.md`, `docs/design/art/VISUAL_QA.md`, `docs/design/audio/AUDIO_QA.md`, `docs/ops/qa/PERFORMANCE_BASELINE.md`
