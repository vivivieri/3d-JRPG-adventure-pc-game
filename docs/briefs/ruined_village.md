...
**Authority:** `docs/design/world/ENVIRONMENT_KITS.md` §4, `docs/design/world/LEVEL_DESIGN.md` §3, `docs/design/art/RENDERING_GUIDE.md`
**Cross-refs:** `docs/design/art/GENERATION_READINESS.md`, `docs/design/art/ART_AUTOMATION_PIPELINE.md` §4–5
