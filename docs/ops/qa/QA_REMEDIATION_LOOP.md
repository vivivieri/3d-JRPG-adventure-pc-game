...
**Cross-refs:** `docs/design/art/MODEL_QA.md`, `docs/design/art/VISUAL_QA.md`, `docs/design/audio/AUDIO_QA.md`, `docs/ops/qa/FLOW_QA.md`, `docs/ops/qa/ACCEPTANCE_CRITERIA.md`, `docs/design/art/ART_AUTOMATION_PIPELINE.md`, `game/data/qa/remediation_playbook.json`
