...
# See docs/engineering/technical/GDSCRIPT_REGENERATION.md
set -euo pipefail
...
print_checklist() {
  ...
  echo "  Full policy: docs/engineering/technical/GDSCRIPT_REGENERATION.md §2"
  echo ""
  echo "Prerequisites:"
...
PY
  ...
  echo ""
  echo "Full guide: docs/engineering/technical/GDSCRIPT_REGENERATION.md"
}
