...
**Snapshot ID + launch checklist:** `docs/agents/CLOUD_SNAPSHOT_LAUNCH.md` — active snapshot `snapshot-20260727-03c79bba-9445-47b4-a7af-559ea395efbd`, boot verification, and `main` vs `game/development` pitfalls.
