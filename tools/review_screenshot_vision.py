#!/usr/bin/env python3
"""Multi-model vision jury for game screenshots (docs/design/art/VISUAL_QA.md §2G).
...
def main() -> int:
    ...
    if active == 0:
        ...
        print("SKIP is not PASS — see docs/ops/qa/ACCEPTANCE_CRITERIA.md")
        return 2
    ...
    print("See docs/ops/qa/QA_REMEDIATION_LOOP.md — change ONE lever before rebuild.")
    print("See docs/ops/qa/ACCEPTANCE_CRITERIA.md — PASS requires measurable criteria met.")
    return 1
