...
**Snapshot ID + launch checklist:** `docs/agents/CLOUD_SNAPSHOT_LAUNCH.md` — active snapshot `snapshot-20260727-ef4f5cd6-2064-4d9f-935f-8a2626c57bd7`, boot verification, and `main` vs `game/development` pitfalls.
