...
**Platform:** PC (Steam) — **Linux + Windows** v1 (macOS v1.1+). Linux required because primary dev runs on Cursor Cloud (Linux). See `docs/ops/qa/PLATFORM_SUPPORT.md`.
**Target audience:** Men 20–30
**Playtime target:** 2–3 hours (main story)
**Genre:** 3D adventure JRPG, turn-based combat

**Related docs:** `docs/design/art/CHARACTER_BIBLE.md`, `docs/design/world/ENVIRONMENT_KITS.md`, `docs/design/gameplay/BOSS_DESIGNS.md`, `docs/design/gameplay/ENCOUNTER_TABLE.md`, `docs/design/ui/CINEMATICS.md`, `docs/design/audio/AUDIO_DIRECTION.md`, `docs/design/audio/AUDIO_PRODUCTION_GUIDE.md`, `docs/ops/qa/QA_AND_BUG_PROCESS.md`, `docs/design/vision/NARRATIVE_WRITING_GUIDE.md`, `docs/design/gameplay/PROGRESSION_TUNING.md`, `docs/design/gameplay/GAME_FEEL.md`, `docs/design/vision/LORE_AND_ENVIRONMENTAL_STORY.md`, `docs/design/world/WORLD_MAP_AND_FLOW.md`, `docs/design/vision/REPLAY_DESIGN.md`, `docs/design/world/QUEST_AND_FLAGS.md`, `docs/design/gameplay/TUTORIAL_DESIGN.md`, `docs/design/vision/ENDING_DESIGN.md`, `docs/design/gameplay/ITEMS_AND_ECONOMY.md`, `docs/design/art/ITEMS_3D_MODEL_GUIDE.md`, `docs/design/gameplay/COMBAT_SYSTEMS.md`, `docs/design/gameplay/SKILLS_BIBLE.md`, `docs/design/ui/UI_UX_FLOW.md`, `docs/engineering/technical/SAVE_AND_FAIL_STATES.md`
