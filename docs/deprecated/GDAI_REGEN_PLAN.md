...
> **Superseded by:** [`docs/workflow/IMPLEMENTATION_PLAN.md`](IMPLEMENTATION_PLAN.md) on branch **`main`**.  
> **Workflow:** GodotPrompter + full MCP stack — see [`.cursorrules`](../.cursorrules) §0 and [`docs/agents/MCP_STACK.md`](MCP_STACK.md).  
...
**Design source:** `main` — `docs/vision/GDD.md`, `docs/vision/STORYBOARD.md`, `docs/art/ART_DIRECTION.md`  
**Tooling:** ~~GDAI MCP only~~ — **obsolete**; current policy: GodotPrompter + GDAI + Godotiq + MCP Pro + tiered art automation (`docs/art/ART_AUTOMATION_PIPELINE.md`).

---

## Setup (once per machine) — OUTDATED

1. Install `uv` — see `docs/agents/GDAI_CLOUD_SETUP.md`
