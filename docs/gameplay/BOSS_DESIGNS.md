...
**3D production:** Full mesh breakdown, poly budgets, GLB paths — `docs/art/CHARACTER_BIBLE.md` §6 (`shore_wraith`).
...
**3D production:** Full mesh breakdown, poly budgets, GLB paths, arena scale — `docs/art/CHARACTER_BIBLE.md` §6 (`palace_sentinel`).
...
**3D production:** Phase mesh swaps, materials, animations — `docs/art/CHARACTER_BIBLE.md` §6 (`tide_keeper`).
