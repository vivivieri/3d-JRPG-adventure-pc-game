...
| Doc | Contents |
|-----|----------|
| `docs/design/art/RENDERING_GUIDE.md` | Tonemap, fog, glow |
| `docs/design/art/ENVIRONMENT_KITS.md` | Per-zone palette rows |
| `docs/design/art/CHARACTER_BIBLE.md` | Spirit/box material states |
