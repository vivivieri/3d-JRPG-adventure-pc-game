...
Use **ACE-Step prompt — `cine_ending_anchor_hero`** when you need this reference during the current task Jump to a section below instead of reading end-to-end (3 sections).
