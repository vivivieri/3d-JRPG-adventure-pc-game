...
Manual fallback: GitHub repo → Settings → Secrets and variables → Actions
  Add CURSOR_PM_CYCLE_WEBHOOK_URL, CURSOR_PM_WEBHOOK_AUTH,
  CURSOR_FACTORY_ALERT_WEBHOOK_URL, CURSOR_ALERT_WEBHOOK_AUTH,
  CURSOR_WORKER_WEBHOOK_URL, CURSOR_WORKER_WEBHOOK_AUTH
...
SECRET_SPECS=(
  ...
  "CURSOR_PM_WEBHOOK_AUTH|CURSOR_PM_WEBHOOK_AUTH|1"
  "CURSOR_FACTORY_ALERT_WEBHOOK_URL|CURSOR_FACTORY_ALERT_WEBHOOK_URL|1"
  "CURSOR_ALERT_WEBHOOK_AUTH|CURSOR_ALERT_WEBHOOK_AUTH|1"
  "CURSOR_WORKER_WEBHOOK_URL|CURSOR_WORKER_WEBHOOK_URL|1"
  "CURSOR_WORKER_WEBHOOK_AUTH|CURSOR_WORKER_WEBHOOK_AUTH|1"
