...
authority: audio
tokens_est: 1953
summary: "An agent can register `bgm_village.ogg` or `sc00_urashima_01.ogg` without listening — often a **procedural sine placeholder**, wrong loudness, or off-direction "
---
...
**Cross-refs:** `docs/design/audio/AUDIO_PRODUCTION_GUIDE.md`, `docs/design/audio/AUDIO_DIRECTION.md`, `docs/design/art/VISUAL_QA.md`, `docs/ops/qa/QA_REMEDIATION_LOOP.md`, `docs/ops/qa/ACCEPTANCE_CRITERIA.md`, `game/data/audio/ace_step_prompts.json`
