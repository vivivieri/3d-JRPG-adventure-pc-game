...
Open `game/project.godot` in Godot **4.7** (Forward+). Cloud: `bash tools/install_cloud_dev.sh`. See `docs/technical/TECH_STACK.md`.
...
**Snapshot ID + launch checklist:** `docs/agents/CLOUD_SNAPSHOT_LAUNCH.md` — active snapshot `snapshot-20260721-10d33103-af0d-45fe-8725-9afae9a3de9d`, boot verification, and `main` vs `game/development` pitfalls.
...
| JRPG UI/combat playtest via live editor | GDAI MCP — see `docs/qa/AI_TESTING_SPEC.md` §11 |
