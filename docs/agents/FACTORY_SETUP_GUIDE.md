...
**Cross-refs:** `docs/agents/CLOUD_AGENT_SETUP_RUNBOOK.md` · `docs/agents/CLOUD_SNAPSHOT_LAUNCH.md` · `game/data/qa/factory_automations.json`
...
| Human at end only | `uat_ready` → L6 playtest (`docs/qa/PLAYTEST_SCRIPT.md`) |
...
| Webhook **payload** scripts | Pasting automation **prompts** from `docs/agents/automation_prompts/` |
...
4. Enable Godotiq editor plugin (`docs/agents/CLOUD_SNAPSHOT_LAUNCH.md` §4 step 4a).
5. Confirm:
...
GameLab SSE config: `docs/agents/CLOUD_SNAPSHOT_LAUNCH.md` §5.
...
Prompt files: `docs/agents/automation_prompts/`
...
| Schedule | **None** |
| Prompt | Paste `docs/agents/automation_prompts/pm_cycle_dispatch.md` |
...
Prompt: `docs/agents/automation_prompts/ci_failure_triage.md`

### Automation C — UAT notify (optional)

Webhook on `uat_ready` only. Prompt: `docs/agents/automation_prompts/uat_notify.md`
...
| Prompt | `docs/agents/automation_prompts/factory_alert.md` |
...
| Doc | Topic |
|-----|--------|
| `docs/agents/CLOUD_AGENT_SETUP_RUNBOOK.md` | Event architecture + automation prompts index |
| `docs/agents/CLOUD_SNAPSHOT_LAUNCH.md` | Snapshot rebuild + Godotiq enable |
| `docs/agents/PM_AGENT_RUNBOOK.md` | PM session steps |
| `docs/agents/SPRINT_ORCHESTRATION.md` | Board + gates |
| `docs/agents/CURSOR_SECRETS_SETUP.md` | All secrets |
