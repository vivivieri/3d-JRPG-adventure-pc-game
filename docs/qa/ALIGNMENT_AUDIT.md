...
**Visual theme:** Auto-generated radars composite live scores onto **legacy reference art** (`tides_audit_radar_updated.png`, `audit_radar_6axis.png`, `tides_audit_alignment_radar.png`) — gold frame, teal polygon, scale legend. Renderer: `tools/audit_radar_legacy_style.py`.
