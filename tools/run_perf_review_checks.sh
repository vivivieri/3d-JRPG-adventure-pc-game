...
#   reference_pc_gtx1060 for Windows Steam depot — docs/ops/qa/PERFORMANCE_BASELINE.md
set -euo pipefail
...
echo "==> Perf review catalog (docs/ops/qa/PERFORMANCE_BASELINE.md, PLATFORM_SUPPORT.md)"
echo ""
