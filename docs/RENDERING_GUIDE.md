...
| VSync | User setting | `docs/SETTINGS_ACCESSIBILITY.md` |
...
Add to settings menu (`docs/SETTINGS_ACCESSIBILITY.md`). Store in `user://settings.json`.
...
**Vertical slice gate:** SC-02 Ruined Village first — `docs/ART_DIRECTION.md` §10.
...
| Path | Role |
|------|------|
| `docs/ART_DIRECTION.md` | Palette, poly budgets, style rules |
| `docs/ENVIRONMENT_KITS.md` | Per-zone lighting tables, fog start |
