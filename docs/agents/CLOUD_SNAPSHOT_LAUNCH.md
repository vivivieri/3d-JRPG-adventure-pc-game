...
| Field | Value |
|-------|-------|
| **Snapshot ID** | `snapshot-20260727-03c79bba-9445-47b4-a7af-559ea395efbd` |
| **Saved** | 2026-07-27 |
...
- [ ] Snapshot in dashboard matches `snapshot-20260727-03c79bba-9445-47b4-a7af-559ea395efbd` (or newer if rebuilt)
