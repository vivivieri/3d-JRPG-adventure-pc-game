...
**Cross-refs:** `docs/ops/qa/FLOW_QA.md`, `docs/design/vision/PACING_CHART.md`, `docs/design/gameplay/GAME_FEEL.md`, `docs/design/gameplay/COMBAT_SYSTEMS.md`, `docs/design/vision/ENDING_DESIGN.md`, `docs/ops/qa/ACCEPTANCE_CRITERIA.md`, `docs/ops/qa/QA_REMEDIATION_LOOP.md`
...
```gdscript
extends Node
## Local-only JSONL playtest telemetry. No PII. See docs/ops/qa/PLAYTEST_TELEMETRY.md.
