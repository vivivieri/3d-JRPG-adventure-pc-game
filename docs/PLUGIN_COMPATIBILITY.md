...
**Verdict:** Safe to proceed with **GDAI + Godotiq** on Godot 4.7. Install **Godot MCP Pro** before L4/L5 automated tests. Upgrade **GodotSteam to 4.20+** before Steam export (Phase 8).
...
- `docs/TECH_STACK.md` — version pins
- `docs/MCP_STACK.md` — role split and ports
