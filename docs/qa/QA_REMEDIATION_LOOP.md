...
**Cross-refs:** `docs/art/MODEL_QA.md`, `docs/art/VISUAL_QA.md`, `docs/audio/AUDIO_QA.md`, `docs/qa/FLOW_QA.md`, `docs/qa/ACCEPTANCE_CRITERIA.md`, `docs/art/ART_AUTOMATION_PIPELINE.md`, `game/data/qa/remediation_playbook.json`
...
| Doc | Role |
|-----|------|
| `docs/qa/FLOW_QA.md` | **Game flow** — L0/L4/L5 progression + flow levers |
| `docs/qa/QA_AND_BUG_PROCESS.md` | Gameplay bugs (S0–S3) — separate from art QA loop |
| `docs/qa/AI_TESTING_SPEC.md` | L0–L6 test layers |
| `docs/qa/PLAYTEST_SCRIPT.md` | Human L6 after automated pass |
...
**Game flow detail:** `docs/qa/FLOW_QA.md` — critical path testing, INT-* scenarios, flow lever taxonomy (`data_fix`, `trigger_wiring`, `flag_logic`, `godotiq_trace`, …).
