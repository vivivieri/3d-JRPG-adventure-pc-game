#!/usr/bin/env python3
"""Check viewport screenshot palette against zone anchors (docs/design/art/VISUAL_QA.md §2D)."""
...
# Mirrors docs/design/art/ART_DIRECTION.md §1 + tools/palette_remap.py
