...
**Cross-refs:** `docs/art/CHARACTER_BIBLE.md`, `docs/art/ITEMS_3D_MODEL_GUIDE.md`, `docs/art/ART_AUTOMATION_PIPELINE.md` §5, `docs/qa/QA_REMEDIATION_LOOP.md`, `docs/qa/ACCEPTANCE_CRITERIA.md`, `docs/art/GENERATION_READINESS.md`, `docs/generation_briefs/`, `game/data/models/qa_catalog.json`
...
**Rule:** Polish is **gate-driven**. Each attempt changes **one lever** (`docs/qa/QA_REMEDIATION_LOOP.md` §3), logs to `revision_log.json`, and re-runs the **full** model layer — not jury-only reruns.
...
|----------|--------|------------|-----------------|
| 1 | `docs/vision/GDD.md`, `docs/vision/STORYBOARD.md` | **PM** (facilitates) | Mood, audience, scene intent |
| 2 | `docs/art/ART_DIRECTION.md`, `docs/art/CHARACTER_BIBLE.md`, `docs/world/ENVIRONMENT_KITS.md` | **PM + design docs** | Palette, silhouettes, zone kits |
...
See `docs/art/GENERATION_READINESS.md` for per-row ⚠️ Partial items that still need human judgment after gates pass.
...
Authority: `docs/audio/AUDIO_QA.md` · Human L6 still owns loop seams, duck mix, subtitle timing.
