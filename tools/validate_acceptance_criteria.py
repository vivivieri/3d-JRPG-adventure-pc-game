#!/usr/bin/env python3
"""Validate acceptance_criteria.json and tool threshold alignment (docs/ops/qa/ACCEPTANCE_CRITERIA.md)."""
...
def main() -> int:
    ...
    required_top = ("version", "global_rules", "gates", "jury", "invalid_pass_patterns", "ci_gates", "docs_ci_gates", "cd_gates")
    ...
    # know what to verify. See docs/ops/qa/ACCEPTANCE_CRITERIA.md.
