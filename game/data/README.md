...
**Start here for all coding + data rules:** [`docs/engineering/technical/CODING_STANDARDS_HUB.md`](../../docs/engineering/technical/CODING_STANDARDS_HUB.md)
**JSON detail:** [`docs/engineering/technical/JSON_DATA_STYLE.md`](../../docs/engineering/technical/JSON_DATA_STYLE.md)
Design rationale: [`docs/engineering/technical/DATA_ARCHITECTURE.md`](../../docs/engineering/technical/DATA_ARCHITECTURE.md)
...
game/data/
  ...
  models/
    qa_catalog.json          # 3D model paths, tri budgets, allowed/required animations (docs/design/art/MODEL_QA.md); v1.3+ adds crowd/npc_cinematic rows
  qa/
    remediation_playbook.json  # Failure code → fix actions (docs/ops/qa/QA_REMEDIATION_LOOP.md)
    acceptance_criteria.json   # Measurable gate thresholds (docs/ops/qa/ACCEPTANCE_CRITERIA.md)
  ...
  code/
    base_classes.json          # Architect-owned base classes + component scenes (docs/engineering/technical/CODE_BASE_CLASS_RULES.md)
    spec_registry.json         # Spec-first gate + artifact index (docs/engineering/technical/SPEC_FIRST_DEVELOPMENT.md)
    autoload_registry.json     # Autoload public API contracts
    helpers_registry.json      # Core helpers + EventBus signals + regen order (docs/engineering/technical/GDSCRIPT_REGENERATION.md)
...
See `docs/engineering/technical/DATA_ARCHITECTURE.md` §17. Summary: `chapter_01.json` = `schema_version: 4`; audio catalogs use `"version": "1.0"`.

## Scene count

- **20** scene headings in `docs/design/vision/STORYBOARD.md` (`SC-00`…`SC-16` = 17, plus 3 ending variants `SC-17a`/`b`/`c`); a single playthrough experiences **18** (one ending only)
...
- [`docs/engineering/technical/CODING_STANDARDS_HUB.md`](../../docs/engineering/technical/CODING_STANDARDS_HUB.md) — naming, schema bumps, extension checklists
- [`docs/engineering/technical/DATA_ARCHITECTURE.md`](../../docs/engineering/technical/DATA_ARCHITECTURE.md) — full architecture
- `docs/design/world/QUEST_AND_FLAGS.md` — quest & flag detail
- `docs/design/gameplay/ITEMS_AND_ECONOMY.md` — item catalog
- `docs/design/art/ITEMS_3D_MODEL_GUIDE.md` — item 3D mesh specs
- `docs/design/gameplay/ENCOUNTER_TABLE.md` — pacing
- `docs/design/vision/REPLAY_DESIGN.md` — replay & gallery
- `docs/design/vision/NARRATIVE_WRITING_GUIDE.md` — writing, selective VO, i18n prose
- `docs/design/vision/VO_HIT_LIST.md` — emotional VO clip list + ElevenLabs generation
- `docs/design/audio/AUDIO_QA.md` — BGM/P0 VO technical + listen jury gates
