...
**Cross-refs:** `docs/ops/qa/QA_REMEDIATION_LOOP.md`, `docs/ops/qa/QA_AND_BUG_PROCESS.md`, `docs/ops/cheat-sheets/RR_CHEATSHEET.md`, `docs/ops/agents/PM_STAKEHOLDER_REPORTING.md`
