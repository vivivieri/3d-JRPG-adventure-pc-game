...
| **GameLab Studio MCP** (`gamelab-mcp`) | UI frames, icon sheets — **required** per `ART_AUTOMATION_PIPELINE.md` |
...
See `docs/ops/agents/MCP_STACK.md` for full R&R and conflict rules.

## MCP plugin compatibility (Godot 4.7)

**Full audit:** `docs/engineering/technical/PLUGIN_COMPATIBILITY.md` — run `bash tools/check_plugin_compatibility.sh` before Phase 1.
**Install steps:** `docs/ops/agents/PLUGIN_INSTALL_GUIDE.md`
