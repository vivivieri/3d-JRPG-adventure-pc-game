...
See `docs/design/vision/ENDING_DESIGN.md` §2.
...
| Doc | Contents |
|-----|----------|
| `docs/design/ui/UI_UX_FLOW.md` | HUD, menus, pause rules |
| `docs/design/gameplay/TUTORIAL_DESIGN.md` | Tutorial prompts (`TUTORIAL_*` keys) |
| `docs/design/gameplay/GAME_FEEL.md` | Camera smoothing, input buffer |
