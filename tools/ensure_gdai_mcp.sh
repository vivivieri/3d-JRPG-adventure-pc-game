...
fail() {
  ...
  echo ""
  echo "Docs: docs/ops/agents/GDAI_CLOUD_SETUP.md"
  exit 1
}
...
if [[ $STACK_OK -eq 0 ]]; then
  fail "Required MCP stack incomplete (Godotiq and/or MCP Pro). See docs/ops/agents/MCP_STACK.md"
fi
...
echo "      Docs: docs/ops/agents/MCP_STACK.md"
echo ""
exit 0
