...
| Source | Count | Notes |
|--------|-------|-------|
| `docs/vision/STORYBOARD.md` | **19** narrative beats | SC-00 + 18 main-path scenes |
...
| `audio/audio_qa_catalog.json` | `version` | **"1.0"** | Unified BGM/VO QA catalog — loudness, jury scope, brief paths (`docs/audio/AUDIO_QA.md`) |
