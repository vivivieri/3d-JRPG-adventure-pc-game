...
authority: qa
tokens_est: 903
summary: "L4 — AI integration tests — covers 6. L4 — AI integration tests; 6.1 Machine-readable catalog; 6.2 Current (Phase 0 baseline); 6.3 Scenarios to implement"
---
...
Use **L4 — AI integration tests** (roles: qa, flow) when you need this reference during the current task Jump to a section below instead of reading end-to-end (6 sections).

## Jump to

- [6. L4 — AI integration tests](#6-l4-ai-integration-tests)
- [6.1 Machine-readable catalog](#61-machine-readable-catalog)
- [6.2 Current (Phase 0 baseline)](#62-current-phase-0-baseline)
- [6.3 Scenarios to implement](#63-scenarios-to-implement)
