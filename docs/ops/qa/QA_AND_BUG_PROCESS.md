...
**Human QA order:** Humans run `PLAYTEST_SCRIPT.md` **only after** AI layers L0–L5 pass (`docs/ops/qa/AI_TESTING_SPEC.md` §0). Bug fixes from human findings go back to AI agents → re-run L0–L5 → human retest.
