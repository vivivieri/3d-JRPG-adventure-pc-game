...
**Registry:** `game/data/code/base_classes.json` · **Rules:** `docs/technical/CODE_BASE_CLASS_RULES.md` · **Component catalog:** `docs/world/LEVEL_DESIGN.md` §1b · **CI:** `L0_base_classes`, `L0_base_class_compliance`, `L1_gdscript_lint`.
...
**Scene paths (canonical):** see `game/data/code/scene_registry.json` + `docs/world/LEVEL_DESIGN.md`.
