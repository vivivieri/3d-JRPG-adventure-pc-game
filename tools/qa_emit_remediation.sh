#!/usr/bin/env bash
# Emit remediation brief after smoke/integration FAIL (docs/ops/qa/QA_REMEDIATION_LOOP.md, docs/ops/qa/FLOW_QA.md).
# Usage:
...
footer() {
  echo "==================================================================="
  echo "Policy: docs/ops/qa/QA_REMEDIATION_LOOP.md | Flow: docs/ops/qa/FLOW_QA.md"
